...
<div class="x_panel">
                        ...
                        <br />
                                    ...
                                    ?>
                                    <form action="<?php echo base_url('operator/pariwisata/proses_tambah');?>" id="demo-form2" enctype="multipart/form-data" name='form1' data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="lokasi" name="lokasi" required="required" class="form-control col-md-7 col-xs-12" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="url" name="url" class="form-control col-md-7 col-xs-12" value="http://">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <textarea id="fasilitas" class="form-control col-md-7 col-xs-12" name="fasilitas"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <textarea id="deskripsi" class="form-control col-md-7 col-xs-12" name="deskripsi"></textarea>                                               
                                            </div>
                                        </div>
